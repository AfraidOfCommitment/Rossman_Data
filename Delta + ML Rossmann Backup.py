...
# MAGIC %sql
# MAGIC select sum(case when CompetitionOpenSinceMonth is null then 1 else 0 end) as CompetitionOpenSinceMonth_NULL from tania.silver_rossmann_sales VERSION AS OF 10
...
# MAGIC FROM tania.silver_rossmann_sales VERSION AS OF 12
